      ...
      <Paper className={classes.paper} elevation={3}>
        ...
        <form className={classes.form} onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            ...
            <Input name="email" label="Adress mail" handleChange={handleChange} type="email" />
            ...
            { isSignup && <Input name="Confirmé mot de passe" label="Repeat Password" handleChange={handleChange} type="password" /> }
          </Grid>
          <Button type="submit" fullWidth variant="contained" color="primary" className={classes.submit}>
            { isSignup ? 'Inscrivez-vous' : 'Connectez' }
          </Button>
          
          <Grid container justify="flex-end">
            <Grid item>
              <Button onClick={switchMode}>
                { isSignup ? 'Conneectez-vous' : "Inscrivez-vous" }
              </Button>
            </Grid>
          </Grid>
        </form>
